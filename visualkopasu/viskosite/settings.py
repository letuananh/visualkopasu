"""
Django settings for viskosite project.
...
SECRET_KEY = '$bjl_vm2l#$60mia@v$ef1pcq3-)rm36lbsz5076%xsexaxaso'
...
ROOT_URLCONF = 'visualkopasu.viskosite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ vkconfig.DJANGO_VIEW_DIR ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'visualkopasu.viskosite.wsgi.application'
