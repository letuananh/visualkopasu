function MRS(parentElement, mrsData, inputElem, sentenceText){
    ...
    function addHandlers(node){
        $(node).find('.variable').hover(
            function (event){
                ...
                var $inputElem = (inputElem == undefined) ? $('#text-input') : inputElem;
                var inputText = (sentenceText != undefined) ? sentenceText : $inputElem.html();
            ...
            function (event){
                ...
                var $inputElem = (inputElem == undefined) ? $('#text-input') : inputElem;
                var inputText = (sentenceText == undefined) ? $inputElem.text() : sentenceText;
                $inputElem.html($inputElem.text());
            }
        ).filter(function (){
